...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">{{ __('Edit Service') }}</h1>
            <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mt-1">{{ __('Update service information') }}</p>
        </div>
    ...
    <div class="bg-white dark:bg-[#161615] rounded-xl shadow-lg border border-[#e3e3e0] dark:border-[#3E3E3A] p-6">
        <form action="{{ route('site.services.update', $service) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="space-y-6">
                <div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="title_en" name="title_en" value="{{ old('title_en', $service->title_en) }}"
                            class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg bg-white dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC]">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="title_ar" name="title_ar" value="{{ old('title_ar', $service->title_ar) }}"
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4" required
                        class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg bg-white dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC]">{{ old('description', $service->description) }}</textarea>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea id="description_en" name="description_en" rows="4"
                            class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg bg-white dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC]">{{ old('description_en', $service->description_en) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description_ar" name="description_ar" rows="4"
                            class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg bg-white dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC]" dir="rtl">{{ old('description_ar', $service->description_ar) }}</textarea>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select id="icon_type" name="icon_type" onchange="toggleIconInput()"
                        class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg bg-white dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC]">
                        <option value="emoji" {{ old('icon_type', $service->icon_type) == 'emoji' ? 'selected' : '' }}>{{ __('Emoji') }}</option>
                        <option value="image" {{ old('icon_type', $service->icon_type) == 'image' ? 'selected' : '' }}>{{ __('Image') }}</option>
                    </select>
                </div>
                ...
                <div id="image_input" style="display: none;">
                    ...
                    @if($service->icon_image_url)
                        <div class="mb-2">
                            <img src="{{ $service->icon_image_url }}" alt="{{ $service->title }}" class="w-16 h-16 object-contain">
                        </div>
                    @endif
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="url" id="link" name="link" value="{{ old('link', $service->link) }}" placeholder="https://..."
                            class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg bg-white dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC]">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="link_text" name="link_text" value="{{ old('link_text', $service->link_text ?? __('Learn More')) }}"
                            class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg bg-white dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC]">
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="link_text_en" name="link_text_en" value="{{ old('link_text_en', $service->link_text_en) }}"
                            class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg bg-white dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC]">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="link_text_ar" name="link_text_ar" value="{{ old('link_text_ar', $service->link_text_ar) }}"
                            class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg bg-white dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC]" dir="rtl">
                    </div>
                </div>
